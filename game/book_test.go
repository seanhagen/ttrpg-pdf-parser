...
func TestPdf_Basics(t *testing.T) {
	...
	expectSections := map[string]string{
		"ONE": `Fusce sagittis, libero non molestie mollis, magna orci ultrices dolor,
at vulputate neque nulla lacinia eros.`,
		"TWO": `Aliquam erat volutpat. Nunc eleifend leo vitae magna. In id erat
non orci commodo lobortis. Proin neque massa, cursus ut, gravida
ut, lobortis eget, lacus. Sed diam. Praesent fermentum tempor
tellus. Nullam tempus. Mauris ac felis vel velit tristique imperdiet.
Donec at pede. Etiam vel neque nec dui dignissim bibendum.
Vivamus id enim. Phasellus neque orci, porta a, aliquet quis,
semper a, massa. Phasellus purus. Pellentesque tristique imperdiet
tortor. Nam euismod tellus id ero.
...
amet urna. Curabitur vulputate vestibulum lorem. Fusce sagi,
libero non molestie mollis, magna orci ultrices dolor, at vulputate
neque nulla lacinia ebum. Sed id ligula quis est convallis tempor.
Curabitur lacinia pulvinar nibh. Nam a sapien.
Liquam erat volutpat. Nunc eleifend leo vitae magna. In id erat
non orci commodo lobortis. Proin neque massa, cursus ut, gravida
ut, lobortis eget, lacus. Sed diam. Praesent fermentum tempor
tellus. Nullam tempus. Mauris ac felis vel velit tristique imperdiet.
Donec at pede. Etiam vel neque nec dui dignissim bibendum.
...
tortor. Nam euismod tellus id erat.`,
	...
	gotContents := book.Contents()

	expectContents := `Section One
Something in section one.
...
`
	...
	require.Equal(t, expectContents, gotContents)
